...
- Σε αυτό το αποθετήριο θα αναρτώνται εκφωνήσεις και βοηθητικό υλικό των ασκήσεων για το εργαστηριακό μέρος του μαθήματος **"Δίκτυα Υπολογιστών"  (2021-2022)**. 

- Οι ασκήσεις σας θα πραγματοποιούνται **MONO** στο *ιδιωτικό σας αποθετήριο* που δημιουργήθηκε με την ενεργοποίηση του συνδέσμου στο eClass κατά τη διάρκεια της 1ης εργαστηριακής άσκησης. 
